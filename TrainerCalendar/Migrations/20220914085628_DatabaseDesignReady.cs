...
{
    public partial class DatabaseDesignReady : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SkillTrainer", x => new { x.SkillsSkillId, x.TrainersTrainerId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SkillTrainer_Trainers_TrainersTrainerId",
